...
class EachIsoform( object ):
    ...
    def __init__( self, info_isoform ):
        ...
        self.last_exon_num = len( self.hashExonList.keys() ) - 1      #-1 because exon starts at 0, not 1
    ...
    def json_isoform_info( self ):
        ...
        for i in range(0, self.last_exon_num):
        ...
        for i in range(0, self.last_exon_num - 1):
    ...
    def get_element( self, position, bool_exon = True, direction = 0, bool_strand = True, rel_pos = None ):
        ...
        ##TEST::
        print "Isoform.get_element: gene = ", self.gene_sym," & position = ", position, " & elems = ", elems
