...
class IsoformSJ( Isoform ):
    ...
    def __init__( self, isoform_id, db_type, list_sj, sj_thres = -2, hash_pos = None, simulant_sj = False, group_sj = 0 ):
        """
        Args:
        ...
        super( IsoformSJ, self ).__init__( isoform_id, db_type, hash_pos )
    ...
    @classmethod
    def is_obj_possible( cls_obj, isoform_id, pos_range, gene_db = 1 ):
        """
        Args:
        ...
        """
        return Isoform.is_obj_possible( isoform_id, pos_range )
    ...
    @staticmethod
    def create_sj_list( list_tuple_pos, chrom, strand, gene_sym, isoform_id = None ):
        """
        Args:
        ...
        for i, sj in enumerate( list_tuple_pos ):
            id = 'SIMSJ_' + str( i )
            #NOTE: new in SVSv6: This is considering "leftmost" & "rightmost"
            record_sj.append( SpliceJunction( id, chrom, sj[0], sj[1], None, None, strand, -1, gene_sym, isoform_id ) )

        return record_sj

    def create_canon_transcript( self, bool_strand = True ):
        """
        Args:
        ...
        for i, sj in enumerate( da_sites ):
            ...
            #NOTE: new in SVSv6: This is considering "leftmost" & "rightmost"
            transcript_sj.append( SpliceJunction( id, self.chrom, sj[0], sj[1], None, None, convert_strand, -1, self.gene_sym, self.isoform_id ) )
    ...
    def sj_canon_absent( self, create_sj = True ):
        ...
        for i, da_site in enumerate( da_sites ):
            ...
            if not canon_sj:
                ...
                id = 'SIMSJ_' + str( i )
                #NOTE: new in SVSv6: This is considering "leftmost" & "rightmost"
                elem = SpliceJunction( id, self.chrom, da_site[0], da_site[1], None, None, self.strand, -1, self.gene_sym, self.isoform_id ) if create_sj else id
    ...
    def reconstruct_transcript_single_sj( self, obj_sj, bool_longest_transcript = True ):
        ...
        list_simulants = IsoformSJ.create_sj_list( da_sites, self.chrom, convert_ss, self.gene_sym )
    ...
    #     simulant_sj = IsoformSJ.create_sj_list( da_sites, self.chrom, str_strand, self.gene_sym, self.isoform_id )
